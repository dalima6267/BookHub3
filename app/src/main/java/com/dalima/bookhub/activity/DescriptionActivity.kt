package com.dalima.bookhub.activity
...
import com.dalima.bookhub.R
import com.dalima.bookhub.database.BookDatabase
import com.dalima.bookhub.util.ConnectionManager
...
class DescriptionActivity : AppCompatActivity() {
                ...
                object : JsonObjectRequest(Request.Method.POST, url, jsonParams, Response.Listener {
                    ...
                    try {
                        ...
                        if (success) {
                            ...
                            val bookEntity = com.dalima.bookhub.database.BookEntity(
                                bookId?.toInt() as Int,
    ...
    class DBAsyncTask(val context: Context, val bookEntity: com.dalima.bookhub.database.BookEntity, val mode: Int) :
        ...
        override fun doInBackground(vararg p0: Void?): Boolean {
            ...
            when (mode) {
                1 -> {
                    val book: com.dalima.bookhub.database.BookEntity = db.bookDao().getBookById(bookEntity.book_id.toString())
                    db.close()
                    return book != null
                }
                //check fav
